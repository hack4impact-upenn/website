            ...
            <Row className="justify-content-center">
              <Col md={8} lg={6}>
                <p className="text-muted">
                  Each semester, we work with three to five non-profits with the opportunity to
                  build a great product that solves a core need. We work in small groups led by a
                  product manager and technical lead to scope and develop the application, taking
                  into account our clients' requirements and suggestions
                </p>
              </Col>
            </Row>
            ...
            <Row className="align-items-center">
              <Col lg={6} className="text-section">
                <h1 className="display-7 mb-4">
                  Not sure how technology can support your nonprofit?
                </h1>
